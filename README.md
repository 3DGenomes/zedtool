...
- `create_backup_columns`: If 1 then backup x_col,y_col,z_col, x_sd_col,y_sd_col,z_sd_col before changing them
...
- `mask_dimensions`: Number of dimensions used when masking detections in binned image (2 or 3)
